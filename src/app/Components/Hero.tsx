    ...
    <>
        <div className="">
            {/* <div className="container"> */}
                <div className="px-3 md:p-0  flex items-center lg:flex-row flex-col ">
                    <div className="after:absolute left-0 bottom-0 bg-[#b08ead] w-[196px] h-[618px] hidden xl:flex"></div>
                        
                    <div className="md:px-[15px] p-0 w-full  md:w-1/2 flex justify-center">
                        <div className="max-w-[416px] basis-[416px]">
                            <h1 className='text-[30px] md:text-[40px]   xl:text-[68px] mb-[10px] font-medium' style={{ color:Theme.colors?.primary?.[3] }}>Best quality pillow</h1>
                    ...
                    <div className=" md:w-1/2 mt-10 lg:m-0   text-left">
